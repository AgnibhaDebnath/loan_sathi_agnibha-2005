                ...
                <div className="flex flex-col items-center pb-3">
                    ...
                    <div className="p-5  rounded-3xl mx-4 md:w-4/5 w-11/12 border-gray-400 border-2">
                        ...
                        <div className=" w-full overflow-x-auto">
                            <table className="border-collapse border-2 border-green-200 min-w-[1091px] w-full">
                                    ...
                                    {emi && emi.map((emi) => (
                                        <tr key={emi.loan_id} className="border-2 text-gray-800 p-2 text-left text-base font-medium">
                                            ...
                                            <td className="bg-gray-100 pl-2">
                                                <span className="block">Due this month :  <IndianRupee className="inline" size={17} strokeWidth={2.5} />{Math.max(0.00, parseFloat(emi.penalty) + parseFloat(emi.emi_amount) - parseFloat(emi.amount_paid)).toFixed(2)}</span>
